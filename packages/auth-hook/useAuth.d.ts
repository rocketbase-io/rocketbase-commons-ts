import { CommonsOauth, CommonsOauthProps } from './src/adapter/commons-oauth';

export { AuthProvider, AuthConfig, useAuth } from "react-use-auth";
...
import { AppUserToken } from '../auth-client/src';
...
export type ProviderOptions = Auth0Options | NetlifyIdentityWidget.InitOptions | CommonsOauthProps;
...
export type AuthUser = (Auth0UserProfile | NetlifyIdentityWidget.User | {} | AppUserToken) & {
  [key: string]: any;
};

export type AuthConfigInterface = (props: {
  // which auth provider to use
  authProvider: typeof Providers.Auth0 | typeof Providers.NetlifyIdentity | typeof CommonsOauth;
