...
export interface ValidationApi {
  validatePassword: RequestorBuilder<string, ValidationResponse<PasswordErrorCodes>>;
  validateUsername: RequestorBuilder<string, ValidationResponse<UsernameErrorCodes>>;
